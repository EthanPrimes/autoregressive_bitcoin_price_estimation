...
\title{Legal Gambling: Predicting the Future Price of Bitcoin}
\author{Ethan Palenske, Rowan Williams}
...
\begin{itemize}
  \item Can we beat a buy-and-hold model?
  \item Can we beat the market?
\end{itemize}
...
\section{Learning Algorithms and In-depth Analysis }
 ...
 Analyze the data using the machine learning techniques discussed in class. Explain what research questions you can answer using the  machine learning techniques presented this semester, and if applicable, what you think you may be able to answer next semester. \cite{Vandermeersch}
...
%%Fifth Section
\section{Ethical Implications and Conclusions: What will we do with our billions?}
